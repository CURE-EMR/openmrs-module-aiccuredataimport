package org.openmrs.module.aiccuredataimport.api.csv.reader;
...
public class SimpleExcelReader {
	...
	public void addIds() throws IOException {
		...
		PatientIdentifierType it = Context.getPatientService().getPatientIdentifierTypeByName("Patient Identifier");
		List<PatientIdentifierType> oldIds = new ArrayList<PatientIdentifierType>();
		oldIds.add(it);
		
		PatientIdentifierType patientIdentifier = Context.getPatientService().getPatientIdentifierTypeByUuid("d0abcb8f-f928-4e37-b498-dc021d757ec6");
